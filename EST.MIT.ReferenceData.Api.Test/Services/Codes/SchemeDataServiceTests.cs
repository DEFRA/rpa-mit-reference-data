...
namespace EST.MIT.ReferenceData.Api.Test.Services.Codes;
...
public class SchemeDataServiceTests
{
    ...
    public async Task GetShouldReturnValidSchemeCodes()
    {
        ...
        // Act
        var codes = (await _schemeDataService.Get(route)).ToArray();
    ...
    {
        // Act / Assert
        await Assert.ThrowsAsync<NotImplementedException>(() => _schemeDataService.Add(null!, null!));
    }
    ...
    {
        // Act / Assert
        await Assert.ThrowsAsync<NotImplementedException>(() => _schemeDataService.AddRange(null!, null!));
    }
    ...
    {
        // Act / Assert
        await Assert.ThrowsAsync<NotImplementedException>(() => _schemeDataService.Update(null!, null!));
    }
}
