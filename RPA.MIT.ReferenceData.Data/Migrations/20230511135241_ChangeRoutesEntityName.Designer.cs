...
namespace EST.MIT.ReferenceData.Data.Migrations
{
    ...
    [Migration("20230511135241_ChangeRoutesEntityName")]
    partial class ChangeRoutesEntityName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EST.MIT.ReferenceData.Data.Models.InvoiceRoute", b =>
                {
                    ...
                    b.HasIndex("DeliveryBodyId")
                        .HasDatabaseName("ix_invoice_routes_delivery_body_id");
            ...
            modelBuilder.Entity("EST.MIT.ReferenceData.Data.Models.InvoiceRoute", b =>
                {
                    b.HasOne("EST.MIT.ReferenceData.Data.Models.RouteComponents.DeliveryBody", "DeliveryBody")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_invoice_routes_delivery_bodies_delivery_body_id");
