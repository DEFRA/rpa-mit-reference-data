...
namespace EST.MIT.ReferenceData.Data.Migrations
{
    ...
    [Migration("20230510102208_AddCombinationModel")]
    partial class AddCombinationModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EST.MIT.ReferenceData.Data.Models.Codes.Combination", b =>
                {
                    ...
                    b.HasOne("EST.MIT.ReferenceData.Data.Models.Route", "Route")
                        .WithMany("Combinations")
                        .HasForeignKey("RouteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_combinations_routes_route_id");
