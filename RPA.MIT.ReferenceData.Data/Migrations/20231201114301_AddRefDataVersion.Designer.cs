...
namespace EST.MIT.ReferenceData.Data.Migrations
{
    ...
    [Migration("20231201114301_AddRefDataVersion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.AccountCode", b =>
                {
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.Combination", b =>
                {
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.DeliveryBodyCode", b =>
                {
                    b.Property<int>("CodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.FundCode", b =>
                {
                    b.Property<int>("CodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.MarketingYearCode", b =>
                {
                    b.Property<int>("CodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.SchemeCode", b =>
                {
                    b.Property<int>("CodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.InvoiceRoute", b =>
                {
                    b.Property<int>("RouteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.ReferenceDataPackageVersion", b =>
                {
                    ...
                    b.HasKey("VersionNumber")
                        .HasName("pk_package_version");

                    b.ToTable("package_version", (string)null);
                });

            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.RouteComponents.InvoiceType", b =>
                {
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.RouteComponents.Organisation", b =>
                {
                    b.Property<int>("ComponentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.RouteComponents.PaymentType", b =>
                {
                    b.Property<int>("ComponentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.RouteComponents.SchemeType", b =>
                {
                    b.Property<int>("ComponentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AccountCodeInvoiceRoute", b =>
                {
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.AccountCode", null)
                        .WithMany()
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.InvoiceRoute", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DeliveryBodyCodeInvoiceRoute", b =>
                {
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.DeliveryBodyCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FundCodeInvoiceRoute", b =>
                {
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.FundCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InvoiceRouteMarketingYearCode", b =>
                {
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.MarketingYearCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InvoiceRouteSchemeCode", b =>
                {
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.SchemeCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.Codes.Combination", b =>
                {
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.AccountCode", "AccountCode")
                        .WithMany()
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.DeliveryBodyCode", "DeliveryBodyCode")
                        .WithMany()
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.InvoiceRoute", "Route")
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.Codes.SchemeCode", "SchemeCode")
                        .WithMany()
            ...
            modelBuilder.Entity("RPA.MIT.ReferenceData.Data.Models.InvoiceRoute", b =>
                {
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.RouteComponents.InvoiceType", "InvoiceType")
                        .WithMany()
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.RouteComponents.Organisation", "Organisation")
                        .WithMany()
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.RouteComponents.PaymentType", "PaymentType")
                        .WithMany()
                    ...
                    b.HasOne("RPA.MIT.ReferenceData.Data.Models.RouteComponents.SchemeType", "SchemeType")
                        .WithMany()
